...
import { accessAssignDetailData, deleteData, ProductionMethodsAndProceduresPropType } from "./util/ProductionMethodsAndProcedures.util";
...
const ProductionMethodsAndProceduresComponent: FC<ProductionMethodsAndProceduresPropType> = ({
    project,
    users,
    user_assignment,
    document_assignment,
                    ...
                    content={
                        <div className="d-flex flex-column">
                            <EditDocumentComponent
                                ...
                                type={"ProductionMethodsAndProcedure"}
                                selected={undefined}
                            />
                            <Popconfirm
                                placement="leftTop"
            ...
            <div className="col-md-12">
                <Table
                    ...
                    dataSource={document_assignment.payload
                        .filter(
                            (e) => e.type === "ProductionMethodsAndProcedure" && e.project_id === project_id
                        )
                        .sort(
                            (a, b) =>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductionMethodsAndProceduresComponent);
