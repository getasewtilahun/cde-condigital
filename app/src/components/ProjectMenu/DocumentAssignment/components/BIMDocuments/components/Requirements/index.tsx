...
import { accessAssignDetailData, deleteData, RequirementsPropType } from "./util/Requirments.util";
...
const RequirementsComponent: FC<RequirementsPropType> = ({
    project,
    users,
    user_assignment,
    document_assignment,
            ...
            <div className="col-md-12">
                <Table
                    ...
                    dataSource={document_assignment.payload
                        .filter(
                            (e) => e.type === "Requirement" && e.project_id === project_id
                        )
                        .sort(
                            (a, b) =>
