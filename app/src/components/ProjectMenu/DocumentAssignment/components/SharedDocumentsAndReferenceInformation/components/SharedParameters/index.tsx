...
import { accessAssignDetailData, deleteData, SharedParametersPropType } from "./util/SharedParameters.util";
...
const SharedParametersComponent: FC<SharedParametersPropType> = ({
    project,
    users,
    user_assignment,
    document_assignment,
            ...
            <div className="col-md-12">
                <Table
                    ...
                    dataSource={document_assignment.payload
                        .filter(
                            (e) => e.type === "SharedParameter" && e.project_id === project_id
                        )
                        .sort(
                            (a, b) =>
...
export default connect(mapStateToProps, mapDispatchToProps)(SharedParametersComponent);
