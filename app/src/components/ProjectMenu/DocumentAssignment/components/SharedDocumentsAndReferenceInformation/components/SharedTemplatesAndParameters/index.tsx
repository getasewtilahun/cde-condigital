...
import { accessAssignDetailData, deleteData, SharedTemplatesAndParametersPropType } from "./util/SharedTemplatesAndParameters.util";
...
import EditDocumentComponent from "../ProjectDocuments/components/EditDocument/EditDocument.component";
import DocumentViewerComponent from "../../../../../../common/DocumentViewer/DocumentViewer.component";
import ActionComponent from "../ProjectDocuments/components/Action/Action.component";

const SharedTemplatesAndParametersComponent: FC<SharedTemplatesAndParametersPropType> = ({
    project,
    users,
    user_assignment,
    document_assignment,
    ...
    const columns = [
        ...
        },
        {
            ...
            width: "200px",
            dataIndex: "statu_s",
            render: (statu_s: string) => {
                const items = statu_s.split(',').map(item => item.trim());
                return (
                    <ul>
                    ...
                    content={
                        <div className="d-flex flex-column">
                            ...
                            <EditDocumentComponent
                                ...
                                type={"SHaredTemplatesAndParameter"}
                                selected={undefined}
                            />
                            <Popconfirm
                                placement="leftTop"
            ...
            <div className="col-md-12">
                <Table
                    ...
                    dataSource={document_assignment.payload
                        .filter(
                            (e) => e.type === "SHaredTemplatesAndParameter" && e.project_id === project_id
                        )
                        .sort(
                            (a, b) =>
...
export default connect(mapStateToProps, mapDispatchToProps)(SharedTemplatesAndParametersComponent);
