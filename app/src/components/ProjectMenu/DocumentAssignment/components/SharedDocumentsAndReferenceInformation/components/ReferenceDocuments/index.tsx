...
import { accessAssignDetailData, deleteData, ReferenceDocumentsPropType } from "./util/ReferenceDocuments.util";
...
const ReferenceDocumentsComponent: FC<ReferenceDocumentsPropType> = ({
    project,
    users,
    user_assignment,
    document_assignment,
            ...
            <div className="col-md-12">
                <Table
                    ...
                    dataSource={document_assignment.payload
                        .filter(
                            (e) => e.type === "ReferenceDocument" && e.project_id === project_id
                        )
                        .sort(
                            (a, b) =>
...
export default connect(mapStateToProps, mapDispatchToProps)(ReferenceDocumentsComponent);
