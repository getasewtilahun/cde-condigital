...
import { accessAssignDetailData, deleteData, ProjectDocumentsPropType } from "./util/ProjectDocuments.util";
...
const ProjectDocumentsComponent: FC<ProjectDocumentsPropType> = ({
    project,
    users,
    user_assignment,
    document_assignment,
            ...
            <div className="col-md-12">
                <Table
                    ...
                    dataSource={document_assignment.payload
                        .filter(
                            (e) => e.type === "ProjectDocument" && e.project_id === project_id
                        )
                        .sort(
                            (a, b) =>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProjectDocumentsComponent);
