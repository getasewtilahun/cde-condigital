...
import { accessAssignDetailData, deleteData, OtherDocumentsPropType } from "./util/OtherDocuments.util";
...
import ActionComponent from "../SharedDocumentsAndReferenceInformation/components/ProjectDocuments/components/Action/Action.component";

const OtherDocumentsComponent: FC<OtherDocumentsPropType> = ({
    project,
    users,
    user_assignment,
    document_assignment,
            ...
            <div className="col-md-12">
                <Table
                    ...
                    dataSource={document_assignment.payload
                        .filter(
                            (e) => e.type === "Other" && e.project_id === project_id
                        )
                        .sort(
                            (a, b) =>
...
export default connect(mapStateToProps, mapDispatchToProps)(OtherDocumentsComponent);
