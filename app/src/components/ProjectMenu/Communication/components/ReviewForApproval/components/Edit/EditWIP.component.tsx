...
const EditWIPComponent: FC<EditWIPPropType> = ({
    user_assignment,
    selected,
    project,
    users,
    ...
    const Submit = (value: any) => {
        ...
        formData.append("id", parseInt(document_assignment.id.toString()));
...
export default connect(mapStateToProps, mapDispatchToProps)(EditWIPComponent);
