...
export type ReviewForApprovalPropType = {
  fetchUsers: Function;
  project: ApiCallState<Project>;
  users: ApiCallState<User[]>;
  user_assignment: ApiCallState<UserAssignment[]>;
  fetchAllUserAssignment: Function;
...
export type AddReviewForApprovalPropType = {
  user_assignment: ApiCallState<UserAssignment[]>;
  project: ApiCallState<Project>;
...
export type EditReviewForApprovalPropType = {
  user_assignment: ApiCallState<UserAssignment[]>;
  project: ApiCallState<Project>;
  selected: UserAssignment | undefined;
  users: ApiCallState<User[]>;
...
export type AttachQualityReportPropType = {
