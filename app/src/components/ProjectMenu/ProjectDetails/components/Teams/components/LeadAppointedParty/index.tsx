...
import {
    ...
    PUT,
    RESET,
} from "../AppointedParty/util/AppointedParty.util";
import { fetchAllUserRole } from "../../../../../../../redux/UserRole/UserRole.action";
const { Search } = Input;

const LeadAppointedPartyComponent: FC<AppointedPartyPropType> = ({
    fetchUsers,
    users,
    fetchUserRoles,
}) => {
                ...
                <div className="col-md-12">
                    <Table
                        ...
                        dataSource={users.payload
                            .filter(
                                (e) => e.organization === "Lead Appointed party 1 (Design and Engineering firm)" || e.organization === "Lead Appointed party 2 (Contractor)"
                            )
                            .map((e, index) => ({
                                ...e,
                                key: index + 1,
