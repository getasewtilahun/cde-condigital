...
export type OrganizationPropType = {
...
export type AddOrganizationPropType = {
    organizations: ApiCallState<Organization>;
    fetchOrganizations: Function;
    project: ApiCallState<Organization>;
...
export type EditOrganizationPropType = {
    fetchOrganizations: Function;
    organizations: ApiCallState<Organization>;
    project: ApiCallState<Organization>;
    fetchOneProject: Function;
...
export const addOrganization = (data: any) =>
    axios.post(API_BASE_URI + "/organization", data, {
    });

export const updateData = (data: any) =>
    axios.put(API_BASE_URI + "/organization", data, {
    });

export const deleteData = (id: number) =>
    axios.delete(API_BASE_URI + `/organization/${id}`);
