  ...
  return (
    <>
      ...
      >
        ...
        <h6> 1. Introduction Welcome to ConDigital, Inc.</h6>
        <p>
          (“Company”, “we”, “our”, “us”)! These Terms of Service (“Terms”,
          “Terms of Service”) govern your use of our website located at
          Cloud.condigitaleth.com (together or individually “Service”) operated
          by ConDigital, Inc.. Our Privacy Policy also governs your use of our
          ...
          (or cannot comply with) Agreements, then you may not use the Service,
          but please let us know by emailing at info@condigitaleth.com so we can
          try to nd a solution. These Terms apply to all visitors, users and
          others who wish to access or use Service.
        </p>
        <h6>2. Communications</h6>
        <p>
          ...
          info@condigitaleth.com.
        </p>
        <h6>3. Contests Sweepstakes and Promotions</h6>
        <p>
        ...
        <p>
          ...
          you have the right to use it and the right to grant us the rights and
          license as provided in these Terms, and (ii) that the posting of your
          ...
          anyone found to be infringing on a copyright. You retain any and all
          of your rights to any Content you submit, post or display on or
          through Service and you are responsible for protecting those rights.
          We take no responsibility and assume no liability for Content you or
          any third party posts on or through Service. However, by posting
          Content using Service you grant us the right and license to use,
          ...
          Terms. ConDigital, Inc. has the right but not the obligation to
          monitor and edit all Content provided by users. In addition, Content
          found on or through this Service are the property of ConDigital, In
          addition, Content found on or through this Service are the property of
          ConDigital, Inc. or used with permission. You may not distribute,
        ...
        <p>
          ...
          enjoyment of Service, or which, as determined by us, may harm or oend
          Company or users of Service or expose them to liability. Additionally,
          you agree not to: 0.1. Use Service in any manner that could disable,
          ...
          including monitoring or copying any of the material on Service. 0.3.
        ...
        <p>
          ...
          property of ConDigital, Inc. and its licensors. Service is protected
          ...
          without the prior written consent of ConDigital, Inc.
        </p>
        <h6>10. Copyright Policy</h6>
        <p>
          ...
          info@condigitaleth.com, with the subject line: “Copyright
        ...
        <h6>11. DMCA</h6>
        <p>
          Notice and Procedure for Copyright Infringement Claims You may submit
          a notification pursuant to the Digital Millennium Copyright Act (DMCA)
          by providing our Copyright Agent with the following information in
          writing (see 17 U.S.C 512(c)(3) for further detail): 0.1. an
          ...
          work exists or a copy of the copyrighted work; 0.3. identification of
          the URL or other specific location on Service where the material that
          you claim is infringing is located; 0.4. your address, telephone
          ...
          copyright owner, its agent, or the law; 0.6. a statement by you, made
          ...
          the copyright owner’s behalf. You can contact our Copyright Agent via
          email at info@condigitaleth.com.
        </p>
        <h6>12. Error Reporting and Feedback</h6>
        <p>
          You may provide us either directly at info@condigitaleth.com or via
          ...
          Feedback; (iii) Feedback does not contain condential information or
          proprietary information from you or any third party; and (iv) Company
          is not under any obligation of condentiality with respect to the
          ...
          and its grants an exclusive, transferable, irrevocable, free-ofcharge,
        ...
        <h6>13. Links To Other Web Sites</h6>
        <p>
          Our Service may contain links to third party web sites or services
          that are not owned or controlled by ConDigital, Inc.. ConDigital, Inc.
          ...
          Terms of Service have been created using PolicyMaker.io, a free web
          application for generating high-quality legal documents. PolicyMaker’s
          free Terms and Conditions generator is an easy-to-use free tool for
          creating an excellent standard Terms of Service template for a
          website, blog, e-commerce store or app. YOU ACKNOWLEDGE AND AGREE THAT
        ...
        <h6> 14. Disclaimer Of Warranty</h6>
        ...
        <p>
          ...
          laws of Addis Ababa, Ethiopia, which governing law applies to
          agreement without regard to its conflict of law provisions. Our
        ...
        <p>
          ...
          any revisions become active, you agree to be bound by the revised
          terms. If you do not agree to the new terms, you are no longer
          authorized to use Service.
        </p>
        <h6>20. Waiver And Severability</h6>
        <p>
